...
* 4个电机端口(M1: 27, 13; M2: 4, 2; M3: 17, 12; M4: 15, 14)；2个步进电机端口(Stepper1: 27, 13, 4, 2; Stepper2: 17, 12, 15, 14)；电流最大达到3.5A；步进电机和直流电机共用IO引脚，使用时注意引脚复用。
* 板载4个RGB灯(16引脚)
* 5个I2C插针接口,1个SPI插针接口
* 4个舵机接口（25、26、32、33）
...
**A**: 1.电机需要DC头供电，6-16V，建议使用两节3.7V锂电池，电源开关是否打到ON；
