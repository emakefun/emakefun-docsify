...
![speech_recognizer_user_flow.svg](picture/speech_recognizer_user_flow.svg)
...
![work_flow_trigger_button.svg](picture/work_flow_trigger_button.svg)

- 关键词触发

![work_flow_trigger_keyword.svg](picture/work_flow_trigger_keyword.svg)
...
![ld3320](picture/speech_recognizer_mindplus_example.png)

**程序解析：** 语音识别模块接Arduino Uno R3主板的I2C接口，当对语音识别模块说“xiao yi xiao yi”时，串口打印0，当对语音识别模块说“bei jing”时，串口打印1。

##### 语音识别和语音合成综合示例

![ld3320_tts](picture/speech_recognizer_and_tts_mindplus_example.png)
