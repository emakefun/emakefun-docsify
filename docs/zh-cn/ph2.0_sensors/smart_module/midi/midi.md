...
<a href="https://gh-proxy.org/https://github.com/emakefun-arduino-library/em_midi/archive/refs/tags/v1.0.0.zip" download>点击此处下载Arduino示例程序</a>

### Arduino 库使用文档

<a href="https://emakefun-arduino-library.github.io/em_midi/html/zh-CN/classem_1_1_midi.html" target="_blank">点击此处查看API说明文档</a>

### Arduino 库示例程序

<a href="https://emakefun-arduino-library.github.io/em_midi/html/zh-CN/drum_pattern_player_8ino-example.html" target="_blank">通道9的打击乐播放</a>

<a href="https://emakefun-arduino-library.github.io/em_midi/html/zh-CN/play_music_8ino-example.html" target="_blank">使用标准GM音色库的钢弦吉他音色播放音乐</a>

## MicroPython 示例程序

### ESP32 MicroPython示例程序

<a href="https://gh-proxy.org/https://github.com/emakefun-micropython-lib/em_mpy_midi/archive/refs/tags/v1.0.0.zip" download>点击下载ESP32 MicroPython示例程序</a>
...
**Microbit MakeCode扩展链接为**: https://github.com/emakefun-makecode-extensions/emakefun_midi

[点击查看小星星示例](https://makecode.microbit.org/_CUmDPi0bXdPF)

[点击查看生日快乐示例](https://makecode.microbit.org/_a98A056hve3b)

[点击查看架子鼓示例](https://makecode.microbit.org/_5hV3Wt7CL4Ye)
