...
void loop(){
  if (myJoystickHandle.Get_Button_Status(BUTTON_A)==PRESS_DOWN) {  // 判断按键A是否按下
    Serial.println("Button_A Pressed");
  }
  if (myJoystickHandle.Get_Button_Status(BUTTON_B)==PRESS_DOWN) {  // 判断按键B是否按下
    Serial.println("Button_B Pressed");
  }
  if (myJoystickHandle.Get_Button_Status(BUTTON_C)==PRESS_DOWN) {  // 判断按键C是否按下
    Serial.println("Button_C Pressed");
  }
  if (myJoystickHandle.Get_Button_Status(BUTTON_D)==PRESS_DOWN) {  // 判断按键D是否按下
    Serial.println("Button_D Pressed");
  }
  if (myJoystickHandle.Get_Button_Status(BUTTON_OK)==PRESS_DOWN) {  // 判断摇杆按键是否按下
  ...
  // Serial.println(myJoystickHandle.Get_Button_Status(BUTTON_A));
  delay(50);
}
```
