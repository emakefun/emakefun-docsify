...
![模块图](./picture/vk16k33_0.4.png)

0.8寸：

![模块图](./picture/vk16k33_0.8.png)

## 原理图

![loading-ag-188](./picture/vk16k33_sch.png)
...
![](./picture/vk16k33_size.png)

<a href="zh-cn/ph2.0_sensors/displayers/vk16k33/vk16k33_3d.zip" download>3D文件</a>
...
[Mixly2.0云端导入PH2.0 Sensors库](https://emakefun.github.io/emakefun-docsify/#/zh-cn/software/mixly/mixly)，导入成功后，点击EmakefunSensors库，选择显示器，找到VK16K33块，如下图：

![mixly_local](./picture/mixly_local.png)

示例：

![vk16k33_mixly_example](./picture/vk16k33_mixly_example.png)

通过连接线将主板的I2C接口和VK16K33数码管的接口相连接，将程序下载到主板，VK16K33数码管将显示数字。

<a href="zh-cn/ph2.0_sensors/displayers/vk16k33/vk16k33_mixly_example.zip" download>点击下载mixly Arduino/ESP32案例</a>

### Mind+示例程序

mind+ 软件Arduino UNO、ESP32库为同一个，使用时，在用户库输入以下链接：https://gitee.com/emakefun_midplus_lib/vk16k33

[点击查看导入方法](https://mindplus.dfrobot.com.cn/extensions-user-libraries)

[点击下载Mind+案例](https://gitee.com/emakefun_midplus_lib/vk16k33/releases/download/v0.0.1/VK16K33MindPlusExample.zip)

## MicroPython示例程序

### ESP32 MicroPython示例程序

<a href="zh-cn/ph2.0_sensors/displayers/vk16k33/vk16k33_esp32_micropython.zip" download>点击下载ESP32 MicroPython示例程序</a>

### micro:bit MicroPython示例程序

<a href="zh-cn/ph2.0_sensors/displayers/vk16k33/vk16k33_microbit_micropython.zip" download>点击下载micro:bit MicroPython示例程序</a>
