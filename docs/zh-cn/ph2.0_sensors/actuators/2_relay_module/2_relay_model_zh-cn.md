...
<img src="./picture/2_relay_module.png" alt="Relay Module" style="zoom: 27%;" />
...
当PH2.0接口引脚S1（S2）输入高电平或者悬空时，继电器断开，即右侧NC1（NC2）引脚和COM1（COM2）连通，对应红色信号灯熄灭；

当PH2.0接口引脚S1（S2）输入低电平时，继电器吸合，右侧NO1（NO2）引脚和COM1（COM2）连通，对应红色信号灯亮起，此时会听到嘀嗒的声音。
...
<img src=".\picture\2_relay_module_ESP32-C3_Mini.png" alt="2_relay_module_ESP32-C3_Mini" style="zoom:50%;" />
...
<span style="color:Red;">注意</span>：1、可直接利用PH2.0外接主控进行控制，也可搭配ESP32-C3 Mini进行控制，用户可自行选择。

​			2、搭配ESP32-C3 Mini时，供电方式可选择TypeC或DC座供电，同时注意对应控制引脚S1(GPIO5)、S2(GPIO6)。
