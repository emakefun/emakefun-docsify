...
![颜色传感器_斜视图1(1)](color_recognition_nlcs11/颜色传感器.jpg)
...
[点击下载Arduino库以及示例程序](color_recognition_nlcs11/read_rgb_ar.zip)
...
[点击下载Micropython库和示例程序](color_recognition_nlcs11/read_rgb_py.zip)
