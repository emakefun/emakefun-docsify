...
<img src="./picture/mixlyDownload.png" title="" alt="mixlyDownload" data-align="center">

 [Mixly2.0 RC4百度云下载链接](https://pan.baidu.com/s/1EdBmAlYFzJ_2rULhKm2g3g?pwd=ny1n)   提取码：ny1n  

点击Mixly2.0文件夹，显示以下文件:

<img title="" src="./picture/mixlyDownloadPackage.png" alt="" data-align="center">
...
<img src="./picture/mixlyOpen.png" title="" alt="mixlyOpen" data-align="center">

打开界面如下，如果主板是Arduino系列，板卡选择Arduino AVR，双击点进编程页面，如下图：

<img src="./picture/mixlyArduino.png" title="" alt="mixlyArduino" data-align="center">

当主板为ESP32芯片时，板卡可以选择Python ESP32,也可选择Arduino ESP32。

<img src="./picture/mixlyPythonESP32.png" title="" alt="" data-align="center">

当选择Arduino ESP32时，在双击“一键更新.bat”时，在弹出的命令框中，需要先安装Arduino ESP32，如下图：

<img title="" src="./picture/mixlyInstallArduinoESP32.png" alt="" data-align="center">

<img src="./picture/mixlyArduinoESP32.png" title="" alt="" data-align="center">

## 二、Mixly界面介绍

<img src="./picture/mixlyWindow.png" title="" alt="mixlyWindow" data-align="center">
...
<img src="./picture/mixlySetup.png" title="" alt="mixlySetup" data-align="center">

**第二步：** 选择对应的用户库。点击”云端导入“，在这里导入我们的PH2.0传感器库，如果未出现库列表，请重新一键更新米思奇软件，如下图：

<img src="./picture/mixlyExport.png" title="" alt="mixlyExport" data-align="center">

导入成功如下图：

<img src="./picture/milxyInstallSuccess.png" title="" alt="milxyInstallSuccess" data-align="center">

第三步：查看是否导入成功。如下图表示导入成功：

<img src="./picture/mixlySensor.png" title="" alt="mixlySensor" data-align="center">

也可以通过点击“本地导入按扭”，导入本地的米思奇库。

详细介绍可以通过米思奇WIKI查看，查看方法如下：

选择"Arduino AVR"板卡---->打开米思奇右上角设置按钮----->点击Wiki，即可查看详细说明。其他板卡是没有这个文档，但都是类似。

<img src="./picture/mixlyWiki.png" title="" alt="" data-align="center">

该库的分类和我们传感器的分类一一匹配。可以按照文档中心的PH2.0模块菜单栏目录找到相应的传感器块的位置。以下库为我们公司产品的库
...
| 7   | ![](./picture/mixlyESP32GD5800Error.png)        | 选择Arduino ESP32板卡时，使用GD5800 MP3块报错，需要双击运行米思奇安装路径下的“一键更新.bat”文件，更新库文件。                                                                      |
